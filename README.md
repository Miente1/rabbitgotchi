...
- Needs: Hunger, Happiness, Energy, Health. Neglect them and it gets sick or dies. **While asleep, everything runs at half the awake pace**: hunger drains at half speed, poop accumulates at half speed, and health penalties apply at half speed. Energy recharges (instead of draining) and happiness holds steady. **Sickness is deferred** — the roll still happens overnight at the normal rate, but the illness is only held pending and *takes hold when the pet wakes up* ("Woke up feeling sick..."), so it can never silently drain health to death overnight while Feed/Play/Medicine are all blocked. Net effect: a pet put to bed with healthy bars is safe overnight, but putting it to bed already hungry/neglected can still cost it (just at half speed).
