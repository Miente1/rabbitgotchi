...
- Needs: Hunger, Happiness, Energy, Health. Neglect them and it gets sick or dies. **Health is fully frozen while asleep** — hunger still drains slowly during sleep and can still hit 0, but that can't cause health damage or death while asleep, since Feed/Play/Discipline are all blocked then and the player has no way to intervene. Health consequences resume the moment it wakes up.
