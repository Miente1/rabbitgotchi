...
- Needs: Hunger, Happiness, Energy, Health. Neglect them and it gets sick or dies. **Sleep is a fully paused, safe state**: nothing degrades and no negative events fire while asleep — hunger, happiness, and health hold steady, no poop, no sickness rolls, no naughty episodes. The *only* thing that changes during sleep is energy recharging back up. Everything resumes the moment it wakes. (This matters because Feed/Play/Discipline are all blocked while asleep, so the pet must never be able to reach a bad state it had no way to prevent.)
